...
public class TransactionQueryBuilder {
    ...
    private static String[] buildFilters(SearchCriteria criteria) {
        ...
        serviceNameFilter(criteria, filters);
    ...
    private static void serviceNameFilter(SearchCriteria criteria, List<String> filters) {
        if (criteria.getType() != null) {
            filters.add(String.format("service_name = %s", criteria.getType()));
        }
    }
}
